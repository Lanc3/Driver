...
Model::Model(GLchar * path)
{
	...
	//m_shader = ResourceManager::LoadShader("..\\ArgoDriver\\Shaders\\texture.vs", "..\\ArgoDriver\\Shaders\\texture.frag", nullptr, "Model");
}

void Model::GetMesh(string name)
{
